...
export default function JobDetailPage() {
  ...
  const dims = job.matchDimensions ?? {
    major: job.matchScore,
    skills: job.matchScore,
    category: job.matchScore,
    industry: job.matchScore,
    location: job.matchScore,
    salary: job.matchScore,
  };

  const radarRows = [
    { label: "专业匹配", value: dims.major },
    { label: "技能匹配", value: dims.skills },
    { label: "岗位类别", value: dims.category },
    { label: "意向行业", value: dims.industry },
    { label: "地理位置", value: dims.location },
    { label: "薪资期望", value: dims.salary },
  ];
